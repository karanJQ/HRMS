...
export const leaveAPI = {
  ...
  cancel: (id, data) => API.delete(`/leaves/applications/${id}`, { data }),
...
export const attendanceAPI = {
  ...
  cancelWFH: (id, data) => API.delete(`/attendance/wfh/${id}`, { data }),
  ...
  cancelRegularization: (id, data) => API.delete(`/attendance/regularize/${id}`, { data }),
